...
```{r echo = FALSE}
table_vars <- c("age", "agecat", "black", "smkever", "educat3", "vegstat3", "take_fo", "bmi", "bmicat")
...
* Four logistic models were fitted using prevalent SLE as the outcome.
  * Model 1 includes: quartile groups of omega-3/omega-6, (DHA + EPA)/omega-6, and ALA/omaga-6
  * Model 2 adds fish oil supplement (no/yes), age groups, race, education level, and smoking status (never/enver)
...
m2 <- update(m1, .~. + take_fo + agecat + black + educat3 + smkever)
