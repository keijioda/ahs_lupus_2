...
* Energy-adjusted FA intake was compared between cases and non-cases. **Note that this is preliminary analysis, since the current data do not have a variable indicating which participants returned the HHF3 questionnaire.**
...
* Ratios of energy-adjusted FA intake were compared between cases and non-cases. **Note that this is preliminary analysis, since the current data do not have a variable indicating which participants returned the HHF3 questionnaire.**
