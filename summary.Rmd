...
* To create an analytic file:
  ...
  * Excluded any subjects with missing gender, education, smoking history, alcohol intake, dietary pattern and BMI
...
```{r echo = FALSE}
table_vars <- c("age", "agecat", "black", "sex", "smkever", "alcever", "educat3", "vegstat3", "take_fo", "bmi", "bmicat", "kcal")
...
* Four logistic models were fitted using prevalent SLE as the outcome.
  ...
  * Model 2 adds age groups, race, gender, education level, smoking status (never/ever), and alcohol (never/ever)
...
m2 <- update(m1, .~. + agecat + black + sex + educat3 + smkever + alcever)
